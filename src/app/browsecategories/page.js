      ...
      <div className="grid md:grid-cols-4 grid-cols-3 px-4 md:px-36 md:gap-9.5 gap-5 pt-4 pb-8 ">
        ...
        <div className="md:col-span-3 col-span-2 grid md:grid-cols-3 grid-cols-2 md:gap-5 gap-3">
          ...
          <div className="flex justify-center py-6">
            <a
              href="/"
              className="md:hidden block border border-black no-underline px-3 py-1.5 rounded-md mt-2  hover:bg-black hover:text-white"
            >
              Load More
            </a>
          </div>
          <div className="flex justify-center py-6">
            <a
              href="/"
              className=" md:block hidden border border-black no-underline px-4 py-1.5 rounded-md mt-2  hover:bg-black hover:text-white"
            >
              Load More
            </a>
          </div>
