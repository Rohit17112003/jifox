          ...
          {productList.map((items) => (
            <div key={items.id || index}>
              <div className="relative group overflow-hidden md:text-[0.9rem] text-[0.7rem]">
                ...
                <div className="absolute inset-0  bg-opacity-50 opacity-100 transition duration-300  bg-white rounded-full h-8.5 w-8.5 flex justify-center items-center md:ml-46 ml-40 mt-3  active:bg-red-700">
